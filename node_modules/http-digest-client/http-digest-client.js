...
var HTTPDigest = function () {
  ...
  //
  HTTPDigest.prototype.request = function (options, data, callback) {
    var self = this;
    var firstReq = http.request(options, function (res) {
      self._handleResponse(options, data, res, callback);
    });
    if (data) {
      firstReq.write(data);
    }
  ...
  //
  HTTPDigest.prototype._handleResponse = function handleResponse(options, data, res, callback) {
    ...
    var secondReq = http.request(options, function (res) {
      callback(res);
    });
    if (data) {
      secondReq.write(data);
    }
    secondReq.end();
  };
