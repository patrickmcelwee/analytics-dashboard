...
angular.module('app').controller('ReportDashCtrl', ['$scope', '$routeParams', '$interval', 'ReportData', 'ReportService', 'WidgetDefinitions',
  function($scope, $routeParams, $interval, ReportData, ReportService, WidgetDefinitions) {
  ...
  $scope.report = {};
  $scope.report.uri = decodeURIComponent($routeParams.uri);
